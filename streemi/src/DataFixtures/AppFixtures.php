...
class AppFixtures extends Fixture
{
    ...
    {
        $array = [
            ['name' => 'Abonnement 6 mois - HD', 'duration' => 6, 'price' => 15,'label'=> 'Le meilleur rapport qualité/prix','description' => 'Un abonnement semestriel pour profiter de pleinement de nos services.'],
            ['name' => 'Abonnement 1 an - HD', 'duration' => 12, 'price' => 25,'label'=> 'Le plus économique','description' => 'Un abonnement annuel pour profiter de pleinement de nos services.'],
            ['name' => 'Abonnement 1 mois - 4K HDR', 'duration' => 1, 'price' => 6,'label'=> 'Idéal pour débuter','description' => 'Un abonnement mensuel flexible pour découvri nos services en qualité 4K HDR.'],
            ['name' => 'Abonnement 3 mois - 4K HDR', 'duration' => 3, 'price' => 15,'label'=> 'Le plus populaire','description' => 'Un abonnement trimestriel pour profiter de pleinement de nos services en qualité 4K HDR.'],
            ['name' => 'Abonnement 6 mois - 4K HDR', 'duration' => 6, 'price' => 30,'label'=> 'Le meilleur rapport qualité/prix','description' => 'Un abonnement semestriel pour profiter de pleinement de nos services en qualité 4K HDR.'],
            ['name' => 'Abonnement 1 an - 4K HDR', 'duration' => 12, 'price' => 50,'label'=> 'Le plus économique','description' => 'Un abonnement annuel pour profiter de pleinement de nos services en qualité 4K HDR.']
        ...
        foreach ($array as $element) {
            ...
            $abonnement->setLabel(label: $element['label']);
